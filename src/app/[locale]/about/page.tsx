...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-50 selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black">
      {/* 1. Hero Section */}
      <section className="min-h-[80vh] flex flex-col justify-center px-4 md:px-8 pt-32 border-b border-neutral-200 dark:border-neutral-800">
        <div className="max-w-5xl mx-auto w-full">
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter mb-8 text-neutral-900 dark:text-neutral-50">
            {t("hero.title")}
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-24 md:py-32 px-4 md:px-8 border-b border-neutral-200 dark:border-neutral-800">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24">
          ...
          <div className="md:col-span-4 relative">
            <div className="md:sticky md:top-48">
              <FadeIn>
                <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6 text-neutral-900 dark:text-neutral-50">
                  {t("process.title")}
                </h2>
            ...
            {[0, 1, 2, 3].map((index) => (
              <FadeIn key={index} delay={index * 0.1}>
                <div className="group border-l border-neutral-200 dark:border-neutral-800 pl-8 py-2 transition-colors hover:border-neutral-900/50 dark:hover:border-neutral-100/50">
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-neutral-900 dark:text-neutral-50 group-hover:text-neutral-600 dark:group-hover:text-neutral-300 transition-colors">
                    {t(`process.steps.${index}.title`)}
                  </h3>
                  <p className="text-neutral-600 dark:text-neutral-400 leading-loose text-lg max-w-xl mb-6">
