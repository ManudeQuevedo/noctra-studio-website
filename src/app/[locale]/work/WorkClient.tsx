...
export default function WorkClient() {
  ...
  const ProjectTimeline = ({ data }: { data: any }) => {
    ...
    return (
      <div className="space-y-6 pt-4" aria-label={`Project progress: currently in ${phases[current_phase - 1] || 'planning'}`}>
              ...
              <div key={phase} className="relative z-10 flex flex-col items-center gap-3">
                ...
                <div className="relative">
                  ...
                  <div className={cn(
                    ...
                    isCurrent ? "bg-black border-emerald-500" :
                    "bg-black border-neutral-700"
                  )}>
                    {isCompleted && <CheckCircle2 className="w-3.5 h-3.5 text-black" strokeWidth={3} />}
                    {isCurrent && <ArrowRight className="w-3.5 h-3.5 text-emerald-500" strokeWidth={3} />}
                    {isPending && <div className="w-1.5 h-1.5 rounded-full bg-neutral-800" />}
                  </div>
                </div>
                {/* Text */}
                <span className={cn(
                  "text-sm font-mono uppercase tracking-wider",
                  isCurrent ? "text-emerald-500 font-bold" : 
                ...
                <motion.div
                  ...
                  <div className="space-y-8 flex-grow">
                    ...
                    <div className="pt-8 border-t border-white/5 pb-4">
                      <h4 className="text-xs font-mono text-neutral-500 uppercase tracking-widest mb-8">{locale === 'es' ? 'Estado del proyecto' : 'Project Status'}</h4>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                ...
                <div className="space-y-8">
                  ...
                  <ul className="space-y-4">
                    {(t.raw("sections.conversion_cta.left_items") as string[]).map((item, i) => (
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    {(t.raw("sections.conversion_cta.right_items") as string[]).map((item, i) => (
                      <div key={i} className="flex gap-4 group">
                        ...
                        <span className="text-neutral-400 leading-tight group-hover:text-neutral-200 transition-colors">{item}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              return (
                <motion.div
                  ...
                  <div className={cn(
                    ...
                    isActive ? "group-hover:bg-emerald-500/10 group-hover:border-emerald-500/20" : "group-hover:bg-blue-500/10 group-hover:border-blue-500/20"
                  )}>
                    <Icon className={cn(
                      "w-6 h-6 transition-colors",
                      isActive ? "text-emerald-500" : "text-neutral-500 group-hover:text-blue-400"
                    )} />
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="p-8 md:p-12 rounded-3xl border border-emerald-500/20 bg-emerald-500/5 space-y-8">
              ...
              <div className="grid grid-cols-1 gap-6">
                {(t.raw("sections.comparison.left_items") as string[]).map((item, i) => (
            ...
            <div className="p-8 md:p-12 rounded-3xl border border-orange-500/20 bg-orange-500/5 space-y-8">
              ...
              <div className="grid grid-cols-1 gap-6">
                {(t.raw("sections.comparison.right_items") as string[]).map((item, i) => (
                  <div key={i} className="flex items-start gap-4 group">
                ...
                >
                  ...
                  <div className="space-y-4 mb-8 flex-grow">
                    <div className="space-y-1">
                      ...
                      <h3 className="text-xl font-bold group-hover:text-emerald-500 transition-colors">{step.label}</h3>
                    </div>
                  ...
                  <div className="space-y-6 pt-6 border-t border-white/5">
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2">
                        {step.deliverables_label.split(':').slice(1).join(':').split('+').map((item: string, idx: number) => (
            ...
            {(t.raw("sections.faq.items") as any[]).map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    onClick={() => setExpandedIndex(isFAQExpanded ? null : faqId)}
