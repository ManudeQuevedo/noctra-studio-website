    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://cdn.noctra.studio https://owlight-widget.vercel.app https://www.googletagmanager.com https://plausible.io",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' blob: data: https: https://cdn.sanity.io https://images.unsplash.com https://placehold.co",
              "font-src 'self' data:",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://vitals.vercel-insights.com https://*.sentry.io https://o172531.ingest.us.sentry.io https://*.sanity.io https://cdn.sanity.io https://cdn.noctra.studio https://owlight.io https://www.owlight.io https://plausible.io",
