  ...
  return (
    <section className="py-24 md:py-32 px-4 md:px-8 bg-neutral-900 text-white relative z-10">
      <div className="max-w-5xl mx-auto">
        <FadeIn>
          <h2 className="text-sm font-mono text-neutral-400 uppercase tracking-widest mb-16">
            {t("manifesto.title")}
          </h2>
        </FadeIn>
              ...
              <FadeIn key={index} delay={index * 0.1}>
                <div className="group flex flex-col h-full justify-between border-l-2 border-neutral-800 pl-6 py-4 hover:border-white hover:bg-neutral-800/50 transition-all duration-300 ease-out rounded-r-sm">
                  <div className="mb-6">
                    ...
                    <h3 className="text-xl font-bold text-white mb-4 tracking-tight text-balance">
                      {t(`manifesto.cards.${index}.title`)}
                    </h3>
                    <p className="text-sm text-neutral-400 leading-relaxed font-medium text-balance">
