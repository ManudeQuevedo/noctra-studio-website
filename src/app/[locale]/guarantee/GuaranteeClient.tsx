        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[0, 1, 2, 3].map((i) => {
              ...
              return (
                <FadeIn key={t(`how_steps.${i}.title`)} delay={i * 0.1}>
      ...
      <section className="py-24 px-6 md:px-8 border-b border-neutral-800 bg-neutral-900/30 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[0, 1, 2].map((i) => (
              <FadeIn key={t(`examples.${i}.type`)} delay={i * 0.1}>
                  ...
                  <div className="space-y-6">
                    <ul className="space-y-4">
                      {(t.raw("example_real.kpis") as string[]).map((kpi, i) => (
                        <li key={kpi} className="flex items-center gap-3 text-lg text-emerald-50/90">
