            ...
            <div className="max-w-7xl mx-auto px-6 py-4 relative">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8 pr-8 md:pr-0">
                ...
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <div>
                    <h3 id="cookie-banner-title" className="font-bold text-white mb-0.5 tracking-tight">
                      {t("title")}
                    </h3>
                    <p className="text-sm text-neutral-400">
                      {t("description")}{' '}
                      <Link href="/cookie-policy" className="text-white underline hover:text-white/80 transition-colors">
                        {t("policy_link")}
                      </Link>
                    </p>
                  </div>
