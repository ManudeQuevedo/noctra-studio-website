...
import { DollarSign, AlertTriangle, Check, Zap, Building2, Briefcase } from "lucide-react";
  ...
  return (
    <div className="space-y-8 max-w-xl mx-auto">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold text-white">What's your budget range for this project?</h2>
        <p className="text-neutral-400">Budget transparency helps us suggest realistic solutions.</p>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-500 group-hover:text-neutral-400">{option.desc}</p>
                </div>
              </div>
              ...
              {option.badge && (
                <div className="hidden sm:flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-white/10 bg-white/5 text-neutral-300">
                  {option.id === "under-10k" ? <AlertTriangle className="w-3 h-3 text-white" /> : <Check className="w-3 h-3" />}
                  {option.badge}
                </div>
              )}
            </div>
