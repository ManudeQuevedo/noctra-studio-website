  ...
  return (
    <div className="space-y-8 max-w-xl mx-auto">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold text-white">Last step! Where should we send your results?</h2>
        <p className="text-neutral-400">We'll also send a detailed PDF report.</p>
      </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-2">
              <label htmlFor="name" className="text-sm font-bold text-neutral-300 uppercase tracking-wider">Your Name *</label>
              <input
                id="name"
                value={formData.name}
            ...
            <div className="space-y-2">
              <label htmlFor="email" className="text-sm font-bold text-neutral-300 uppercase tracking-wider">Email Address *</label>
              <input
                id="email"
                type="email"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label htmlFor="phone" className="text-sm font-bold text-neutral-300 uppercase tracking-wider">Phone (Optional)</label>
              <input
                id="phone"
                type="tel"
            ...
            <div className="space-y-2">
              <label htmlFor="company" className="text-sm font-bold text-neutral-300 uppercase tracking-wider">Company (Optional)</label>
              <input
                id="company"
        ...
        <div className="pt-4 border-t border-neutral-800">
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <div className="text-sm text-neutral-300 group-hover:text-white transition-colors">
              I'd like a <span className="text-white font-bold">free 15-min consultation</span> to discuss my project strategy.
            </div>
          </label>
        </div>
