          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/[0.05]">
                <p className="text-neutral-400 text-sm mb-2">{t("2").split(":")[0]}</p>
                <p className="text-xl font-bold text-white uppercase">{data.price}</p>
              </div>
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/[0.05]">
                <p className="text-neutral-400 text-sm mb-2">{t("3").split(":")[0]}</p>
                <p className="text-xl font-bold text-white uppercase">{data.time}</p>
              </div>
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/[0.05]">
                <p className="text-neutral-400 text-sm mb-2">{t("4").split(":")[0]}</p>
                <p className="text-xl font-bold text-white uppercase">{data.roi}</p>
              </div>
            </div>
