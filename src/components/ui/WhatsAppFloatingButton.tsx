    ...
    <LazyMotion features={domAnimation}>
      <m.div
        ...
        <a
          ...
          aria-label={t("aria_label")}
          className="flex h-11 w-11 items-center justify-center rounded-full border-[0.5px] border-white/15 bg-[rgba(255,255,255,0.08)] text-white shadow-sm backdrop-blur-sm transition-all duration-200 ease-[ease] hover:border-white/30 hover:bg-[rgba(255,255,255,0.15)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/40">
